...
import '../Executive/css/ExecutiveNavbar.css';
                ...
                <div className="container-fluid">
                    ...
                    <div className="d-flex align-items-center">
                        ...
                        <div className="dropdown">
                            ...
                            >
                                <li>
                                    <Link className="dropdown-item" to="/executive/profile">My profile</Link>
                                </li>
                                <li>
                                    <Link className="dropdown-item" to="/executive/profile">Settings</Link>
                                </li>
                                <li>
